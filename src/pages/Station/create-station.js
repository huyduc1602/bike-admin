...
function CreateStation() {
    ...
    const handleChange = (event) => {
        setActive(event.target.checked ? 'ACTIVE' : 'DEACTIVE');
                    ...
                    <FormGroup row className="mt-5">
                        ...
                        <Col sm={10}>
                            <Input
                                id="longtitude"
                                name="longtitude"
                                value={String(station.longtitude)}
                                onChange={(e) => handleEdit(e)}
